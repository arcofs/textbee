...
//        TextBeeUtils.startStickyNotificationService(mContext);
        ...
        scanQRBtn.setOnClickListener(view -> {
            ...
            intentIntegrator.setPrompt("Go to textbee.arcofs.app/dashboard and click Register Device to generate QR Code");
        ...
        checkUpdatesBtn.setOnClickListener(view -> {
            ...
            String downloadUrl = "https://textbee.arcofs.app/download?currentVersion=" + encodedVersionInfo;
