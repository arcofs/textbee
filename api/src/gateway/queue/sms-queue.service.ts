...
export class SmsQueueService {
  ...
  constructor(
    ...
    const useQueue = this.configService.get('USE_SMS_QUEUE', 'false')
    this.useSmsQueue = String(useQueue) === 'true'
    this.logger.debug(
      `SmsQueueService initialized. useSmsQueue: ${this.useSmsQueue}`,
    )
